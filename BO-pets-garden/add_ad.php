...
$query = "INSERT INTO ads SET profile_id=:profile_id, animal_type=:animal_type, start_date=:start_date, end_date=:end_date, city=:city, comments=:comments, animal_photo=:animal_photo";
